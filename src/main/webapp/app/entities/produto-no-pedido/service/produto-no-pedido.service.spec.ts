    ...
    describe('Service methods', () => {
      ...
      describe('addProdutoNoPedidoToCollectionIfMissing', () => {
        ...
        it('should add only unique ProdutoNoPedido to an array', () => {
          const produtoNoPedidoArray: IProdutoNoPedido[] = [{ id: 123 }, { id: 456 }, { id: 30885 }];
        ...
        it('should return initial array if no ProdutoNoPedido is added', () => {
          const produtoNoPedidoCollection: IProdutoNoPedido[] = [{ id: 123 }];
          expectedResult = service.addProdutoNoPedidoToCollectionIfMissing(produtoNoPedidoCollection, undefined, null);
          expect(expectedResult).toEqual(produtoNoPedidoCollection);
        });
      });
    });

...
import br.execute.ecommerce.service.UsuarioQueryService;
import br.execute.ecommerce.service.UsuarioService;
...
/**
 * REST controller for managing {@link br.execute.ecommerce.domain.Usuario}.
 */
@RestController
@RequestMapping("/api")
